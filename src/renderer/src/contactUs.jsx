    ...
    <div className="contact-us-page">
      ...
      <nav className="navbar navbar-expand-lg navbar-dark"
        ...
        <div className="container-fluid">
          <a className="navbar-brand fw-bold fs-4" href="/">The Byter Machine</a>
          <button
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item">
                <a className="nav-link" href="/join">Join with us</a>
              </li>
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu">
                  <li><a className="dropdown-item" href="/projects/snake">Snake Game</a></li>
                  <li><a className="dropdown-item" href="/projects/compiler">Node Compiler</a></li>
                  <li><hr className="dropdown-divider" /></li>
                  <li><a className="dropdown-item" href="/portfolio">View All</a></li>
                </ul>
              </li>
              <li className="nav-item">
                <a className="nav-link disabled" href="#">Classroom</a>
              </li>
            </ul>
            <form className="d-flex">
              <input className="form-control me-2" type="search" placeholder="Search team/projects..." />
      ...
      {/* Team Cards */}
      <div className="container team-grid" style={{ display: 'flex', marginTop: '3%', flexWrap: 'wrap', gap: '2%' }}>
      ...
      <div className="container mt-5">
        <div className="row">
          <div className="col-md-6">
            <div className="contact-card p-4 rounded-4 shadow-lg" style={{
              background: 'linear-gradient(145deg, #f0f2f5, #ffffff)',
              border: '1px solid rgba(0,123,255,0.1)'
            }}>
              <h3 className="mb-4"><i className="bx bx-envelope text-primary"></i> Get In Touch</h3>
              <form>
                <div className="mb-3">
          ...
          <div className="col-md-6">
            <div className="contact-info-card p-4 rounded-4 shadow-lg" style={{
              background: 'linear-gradient(145deg, #f8f9fa, #e9ecef)',
              border: '1px solid rgba(0,123,255,0.1)'
            }}>
              <h3 className="mb-4"><i className="bx bx-map-pin text-success"></i> Contact Details</h3>
              ...
              <div className="social-links mb-3">
                <a href="#" className="social-link mx-2"><i className="bx bxl-github"></i></a>
                <a href="#" className="social-link mx-2"><i className="bx bxl-linkedin"></i></a>
                <a href="#" className="social-link mx-2"><i className="bx bxl-twitter"></i></a>
                <a href="#" className="social-link mx-2"><i className="bx bxl-discord"></i></a>
              </div>
            </div>
          </div>
        </div>
