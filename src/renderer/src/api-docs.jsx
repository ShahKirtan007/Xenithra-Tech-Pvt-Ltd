        ...
        <div className="api-docs-container">
            ...
            <header className="api-docs-header">
                <div className="header-content">
                    <h1><i className='bx bx-book'></i> API Documentation</h1>
            ...
            <div className="api-docs-content">
                ...
                <div className="api-main-panel">
                    ...
                    <section id="overview" className="api-section">
                        <h2>API Overview</h2>
                        <p>The Node Compiler API provides comprehensive endpoints for code compilation, user management, collaboration, and analytics.</p>
                    ...
                    <section id="examples" className="api-section">
                        ...
                        <div className="example-content">
                            <pre><code>{exampleSnippets[activeExampleTab]}</code></pre>
                        </div>
                    </section>
                </div>
            </div>
            ...
            {/* API Test Modal */}
            <div className={`modal fade ${showTestModal ? 'show d-block' : ''}`} id="apiTestModal" tabIndex="-1">
                            ...
                            <form>
                                <div className="row">
                                    <div className="col-md-8">
                                        <div className="mb-3">
                                            <label htmlFor="testEndpoint" className="form-label">Endpoint</label>
                                            <input
                                                type="text"
                                    ...
                                    <div className="col-md-4">
                                        <div className="mb-3">
                                            <label htmlFor="testMethod" className="form-label">Method</label>
                                            <select
                                                className="form-control"
                                                id="testMethod"
                                ...
                                <div className="mb-3">
                                    <label htmlFor="testHeaders" className="form-label">Headers (JSON)</label>
                                    <textarea
                                        className="form-control"
                                        id="testHeaders"
                                        rows="3"
                                ...
                                <div className="mb-3">
                                    <label htmlFor="testBody" className="form-label">Request Body (JSON)</label>
                                    <textarea
                                        className="form-control"
                                        id="testBody"
                                        rows="5"
            ...
            {/* Export Modal */}
            <div className={`modal fade ${showExportModal ? 'show d-block' : ''}`} id="exportModal" tabIndex="-1">
