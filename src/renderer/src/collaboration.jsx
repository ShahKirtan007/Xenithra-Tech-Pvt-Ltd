    ...
    const renderSessionCard = (session) => (
        <div key={session.id} className="session-card">
            ...
            <div className="session-meta">
                <span><i className='bx bx-user'></i> {session.creator}</span>
                <span><i className='bx bx-code-alt'></i> {session.language}</span>
                <span><i className='bx bx-group'></i> {session.members}</span>
            </div>
            <div className="session-actions">
                <button className="btn btn-sm btn-outline-primary" onClick={() => setShowSessionModal(true)}>
                    Details
                </button>
    ...
    const renderComment = (comment) => (
        <div key={comment.id} className="comment-item">
            <div className="comment-header">
                ...
                <span className={`comment-type badge bg-${comment.type === 'question' ? 'info' : comment.type === 'suggestion' ? 'warning' : 'secondary'}`}>
                    {comment.type}
                </span>
        ...
        <div className="collaboration-container">
            ...
            <header className="collaboration-header">
                <div className="header-content">
                    <h1><i className='bx bx-group'></i> Code Collaboration</h1>
            ...
            {showActiveSessionBanner && activeSession && (
                <div className="active-session-banner">
                    <div className="banner-content">
                        ...
                        <span>Active in session: <strong>{activeSession.title}</strong></span>
            ...
            <div className="collaboration-content">
                ...
                <div className="comments-section">
                    ...
                    <div className="comments-list">
                        ...
                        <button className="btn btn-outline-primary btn-sm mt-3" onClick={() => setShowCommentModal(true)}>
                ...
                <div className="modal-dialog modal-lg">
                    <div className="modal-content">
                        ...
                        <div className="modal-footer">
                            ...
                            <button type="button" className="btn btn-primary">Join Session</button>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <form onSubmit={handleCreateSession}>
                                    ...
                                    <div className="col-md-6">
                                        <div className="mb-3">
                                            ...
                                            <input
                                                ...
                                                onChange={(e) => setCreateSessionForm({ ...createSessionForm, projectId: e.target.value })}
                                                required
                                    ...
                                    <div className="col-md-6">
                                        <div className="mb-3">
                                            ...
                                            <select
                                                ...
                                                onChange={(e) => setCreateSessionForm({ ...createSessionForm, language: e.target.value })}
                                            >
                                ...
                                <div className="mb-3">
                                    <label htmlFor="initialCode" className="form-label">Initial Code (Optional)</label>
                                    <textarea
                                        className="form-control"
                                        id="initialCode"
                                        rows="8"
                                        value={createSessionForm.initialCode}
                                        onChange={(e) => setCreateSessionForm({ ...createSessionForm, initialCode: e.target.value })}
                                ...
                                <div className="mb-3">
                                    <div className="form-check">
                                        <input
                                            ...
                                            onChange={(e) => setCreateSessionForm({ ...createSessionForm, isPublic: e.target.checked })}
                                        />
