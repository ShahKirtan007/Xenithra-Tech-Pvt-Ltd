        ...
        <div className="achievements-container">
            ...
            <header className="achievements-header">
                <div className="header-content">
                    <h1><i className='bx bx-trophy'></i> Achievements</h1>
            ...
            <div className="leaderboard-section">
                <h2><i className='bx bx-medal'></i> Leaderboard</h2>
                ...
                <div className="achievement-notification" id="achievementNotification">
                    <div className="notification-content">
                        ...
                        <div className="achievement-info">
                            ...
                            <p id="notificationDescription">{notificationData.description || 'Congratulations on your achievement!'}</p>
                        </div>
