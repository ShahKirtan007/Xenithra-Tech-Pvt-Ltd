...
const AnalyticsPage = () => {
    ...
    useEffect(() => {
        ...
        setRecentCompilations([
            { date: '2025-12-25', language: 'JavaScript', status: 'Success', time: '180ms', size: '2.4KB' },
            { date: '2025-12-24', language: 'Python', status: 'Failed', time: 'N/A', size: '1.8KB' },
            { date: '2025-12-23', language: 'JavaScript', status: 'Success', time: '320ms', size: '3.1KB' }
        ]);
    }, []);
        ...
        <div className="analytics-container">
            ...
            <header className="analytics-header">
                <div className="header-content">
                    <h1><i className='bx bx-bar-chart'></i> Analytics Dashboard</h1>
            ...
            <div className="stats-section">
                <div className="stat-card">
                    ...
                    <div className="stat-info">
                        ...
                        <span className="stat-change" id="compilationsChange">+12%</span>
                    </div>
                </div>
                ...
                <div className="stat-card">
                    ...
                    <div className="stat-info">
                        ...
                        <p>Success Rate</p>
                        <span className="stat-change" id="successChange">+8%</span>
                    </div>
                </div>
                ...
                <div className="stat-card">
                    ...
                    <div className="stat-info">
                        ...
                        <span className="stat-change" id="timeChange">-3%</span>
                    </div>
                </div>
                ...
                <div className="stat-card">
                    ...
                    <div className="stat-info">
                        ...
                        <p>Active Days</p>
                        <span className="stat-change" id="daysChange">+5%</span>
                    </div>
                </div>
            </div>
                            ...
                            <tbody>
                                {recentCompilations.map((compilation, index) => (
                                    <tr key={index}>
                                        ...
                                        <td>
                                            <span className={`badge ${compilation.status === 'Success' ? 'bg-success' : 'bg-danger'}`}>
                                                {compilation.status}
                                            </span>
                                        </td>
